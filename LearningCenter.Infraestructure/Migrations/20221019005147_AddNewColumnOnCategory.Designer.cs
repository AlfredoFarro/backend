...
namespace LearningCenter.Infraestructure.Migrations
{
    ...
    [Migration("20221019005147_AddNewColumnOnCategory")]
            ...
            modelBuilder.Entity("LearningCenter.Infraestructure.Category", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        ...
                        .HasDefaultValue(new DateTime(2022, 10, 18, 19, 51, 47, 329, DateTimeKind.Local).AddTicks(4490));
            ...
            modelBuilder.Entity("LearningCenter.Infraestructure.Tutorial", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2022, 10, 18, 19, 51, 47, 329, DateTimeKind.Local).AddTicks(6460));
            ...
            modelBuilder.Entity("LearningCenter.Infraestructure.User", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2022, 10, 18, 19, 51, 47, 329, DateTimeKind.Local).AddTicks(8500));
