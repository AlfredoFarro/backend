...
namespace LearningCenter.Infraestructure.Migrations
{
    ...
    [Migration("20221021210302_AddColumsOnUserTable")]
    partial class AddColumsOnUserTable
    {
            ...
            modelBuilder.Entity("LearningCenter.Infraestructure.Category", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        ...
                        .HasDefaultValue(new DateTime(2022, 10, 21, 16, 3, 2, 197, DateTimeKind.Local).AddTicks(5590));
            ...
            modelBuilder.Entity("LearningCenter.Infraestructure.Tutorial", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2022, 10, 21, 16, 3, 2, 197, DateTimeKind.Local).AddTicks(7740));
            ...
            modelBuilder.Entity("LearningCenter.Infraestructure.User", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2022, 10, 21, 16, 3, 2, 197, DateTimeKind.Local).AddTicks(9980));
