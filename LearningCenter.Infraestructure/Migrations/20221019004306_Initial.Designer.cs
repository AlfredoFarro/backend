...
namespace LearningCenter.Infraestructure.Migrations
{
    ...
    [Migration("20221019004306_Initial")]
            ...
            modelBuilder.Entity("LearningCenter.Infraestructure.Category", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        ...
                        .HasDefaultValue(new DateTime(2022, 10, 18, 19, 43, 6, 705, DateTimeKind.Local).AddTicks(2490));
            ...
            modelBuilder.Entity("LearningCenter.Infraestructure.Tutorial", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2022, 10, 18, 19, 43, 6, 705, DateTimeKind.Local).AddTicks(4430));
            ...
            modelBuilder.Entity("LearningCenter.Infraestructure.User", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2022, 10, 18, 19, 43, 6, 705, DateTimeKind.Local).AddTicks(6300));
