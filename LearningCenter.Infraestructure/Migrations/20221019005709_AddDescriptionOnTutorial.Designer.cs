...
namespace LearningCenter.Infraestructure.Migrations
{
    ...
    [Migration("20221019005709_AddDescriptionOnTutorial")]
    partial class AddDescriptionOnTutorial
    {
            ...
            modelBuilder.Entity("LearningCenter.Infraestructure.Category", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        ...
                        .HasDefaultValue(new DateTime(2022, 10, 18, 19, 57, 8, 878, DateTimeKind.Local).AddTicks(7260));
            ...
            modelBuilder.Entity("LearningCenter.Infraestructure.Tutorial", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2022, 10, 18, 19, 57, 8, 878, DateTimeKind.Local).AddTicks(9010));
            ...
            modelBuilder.Entity("LearningCenter.Infraestructure.User", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2022, 10, 18, 19, 57, 8, 879, DateTimeKind.Local).AddTicks(840));
